...
## Setup
1. Open PowerShell
2. Clone the repo: `git clone https://github.com/jainasoja/photo_detection.git` or download it as a zip and extract in you folders (this does not require git) 
